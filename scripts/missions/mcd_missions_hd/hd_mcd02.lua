...
MISSION.Init = function()									-- Preparing Introduction
	...
	local playerCar = gameses:CreateCar("hd_principal", CAR_TYPE_NORMAL)	-- Create player car
...
function MISSION.SetupFlybyCutscene()
	...
	missionmanager:ScheduleEvent( function() 
		sounds:Emit2D( EmitParams.new("wind.mcd02a"), -1 )
	end, 1.5);

	missionmanager:ScheduleEvent( function() 
		sounds:Emit2D( EmitParams.new("wind.mcd02b"), 0 )
	end, 2.0);
