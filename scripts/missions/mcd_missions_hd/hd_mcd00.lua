...
MISSION.Init = function()
	...
	MISSION.Data = {
		...
		parkedCars = {
			...
			-- cars by left side
			{ "hd_toledosedan", Vector3D.new(127,0.70,-158), Vector3D.new(122,-90,-122), 0 },
			{ "hd_scimitar", Vector3D.new(127,0.70,-162), Vector3D.new(122,-90,-122), 1 },
			{ "hd_scimitar", Vector3D.new(90,0.70,-117), 	Vector3D.new(146,-90,-146), 5 },
			{ "hd_toledosedan", Vector3D.new(110,0.70,-166), Vector3D.new(66,90,66), 2 },
			{ "hd_scimitar", Vector3D.new(127,0.70,-124), Vector3D.new(122,-90,-122), 6 },
			{ "hd_toledosedan", Vector3D.new(127,0.70,-132), Vector3D.new(122,-90,-122), 3 },
			{ "hd_scimitar", Vector3D.new(127,0.70,-144), Vector3D.new(122,-90,-122), 3 },
			
			-- cars by right side
			{ "hd_scimitar", Vector3D.new(72,0.60,-171), Vector3D.new(72,90,72), 1 },
			{ "hd_toledosedan", Vector3D.new(72,0.60,-165), Vector3D.new(72,90,72), 4 },
			{ "hd_toledosedan", Vector3D.new(72,0.60,-161), Vector3D.new(72,90,72), 2 },
			{ "hd_scimitar", Vector3D.new(72,0.60,-152), Vector3D.new(72,90,72), 6 },
			{ "hd_scimitar", Vector3D.new(72,0.60,-146), Vector3D.new(72,90,72), 5 },
			{ "hd_toledosedan", Vector3D.new(72,0.60,-132), Vector3D.new(72,90,72), 3 },
			{ "hd_scimitar", Vector3D.new(72,0.60,-128), Vector3D.new(72,90,72), 2 },
		},
