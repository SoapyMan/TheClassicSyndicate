...
MISSION.Init = function()
	MISSION.Data = {
		targetPosition = Vector3D.new(263.56,0.60,-425.35),
		target2Position = Vector3D.new(642.50,0.60,-1393.49),
	...
	gameHUD:ShowAlert("TICCO'S RIDE", 3.5, HUD_ALERT_NORMAL)
...
function MISSION.Phase1Start()
	...
	missionmanager:EnableTimeout( true, 75 ) -- enable, time
end
