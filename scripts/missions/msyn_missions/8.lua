...
MISSION.Init = function()
	MISSION.Data = {
		targetPosition = Vector3D.new(633.82,0.57,615.74),
		target2Position = Vector3D.new(1496.06,0.60,-246.57),
	...
	gameHUD:ShowAlert("A SHIPMENT'S COMING IN", 3.5, HUD_ALERT_NORMAL)
...
function MISSION.Phase2Start()
	...
	gameHUD:ShowScreenMessage("Get out of here and back to the motel.", 3.5)
